...
export declare const currentLanguage: import("vue").Ref<string, string>;
export declare const availableLanguages: import("vue").Ref<string[], string[]>;
...
export declare const computedCurrentLanguage: import("vue").ComputedRef<string>;
